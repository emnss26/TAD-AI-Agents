...
DATA_PATH  = os.path.join(
    REPO_ROOT, "Revit-Agent", "agent-revit-coder", "data", "train_data_llama.jsonl"
)
...
# 4. Cargar y tokenizar el dataset explícito
...
print(f"GPU0 → Train: {len(train_ds)}, Eval: {len(eval_ds)}")
...
if __name__ == "__main__":
    print("🚀 GPU0: Fine-tune LoRA con datos explícitos …")
    trainer.train()
    trainer.save_model(OUTPUT_DIR)
    print(f"✅ GPU0: Modelo guardado en {OUTPUT_DIR}")